...
```
The previous example will load the latest bundled code from the esm branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-incr-mapcorr/tags). For example,

```javascript
import incrmapcorr from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-mapcorr@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/stats-incr-mapcorr/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/stats-incr-mapcorr/actions/workflows/test.yml?query=branch:v0.2.3
...
[deno-readme]: https://github.com/stdlib-js/stats-incr-mapcorr/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-incr-mapcorr/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-incr-mapcorr/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-incr-mapcorr/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-incr-mapcorr/blob/esm/README.md
